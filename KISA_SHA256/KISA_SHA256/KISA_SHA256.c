...
int main(){
	BYTE out[32];
	//BYTE *in = "abc";
	BYTE *in = "abcdefghbcdefghicdefghijdefghijkefghijklfghijklmghijklmnhijklmnoijklmnopjklmnopqklmnopqrlmnopqrsmnopqrstnopqrstu";
	...
	start = clock();
	for (i = 0; i < times; i++)
		SHA256_Encrpyt(in, length, out);
	end = clock();
	printf("KISA's SHA-256, %d times\n", times);
